...
function edit_task(task_id) {
    ...
    //make description and status fields editable
    //.parent().parent() - 1st parent - table data, 2nd - table row
...
function update_task(task_id) {
    ...
    //async query, we don't wait for result
    setTimeout(() => {
